...
from .observation_selectors import BLOOD_GLUCOSE_ENTRY_FIELD, \
    ...
    PATIENT_STATUS_ENTRY_FIELD, LOCATION_ENTRY_FIELD, \
    AREAS_CONCERN_ENTRY_FIELD, INTERVENTION_NEEDED_ENTRY_FIELD, \
    INTERVENTION_STAFF_ENTRY_FIELD, OTHER_NOTES_ENTRY_FIELD
...
element_dict = {
    ...
    'Therapeutic': THERAPEUTIC_FORM_DATA_TYPE,
    'Patient Status': PATIENT_STATUS_ENTRY_FIELD,
